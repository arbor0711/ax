...
import { Project, projectsInfo, toolkit } from "../data/data";
              ...
              <section className="flex flex-col items-center md:flex-row md:justify-between px-10">
                <div className="w-full md:w-2/4">
                  <p>
                    ...
                    accessibility and usability. I am a team player who
                    collaborates effectively with cross-functional teams,
                    appreciates knowledge sharing, and values continuous growth
                    for all team members.
                    <br />
                    As a technology and gaming enthusiast, I believe I can
                    deliver high-quality solutions that consistently meet and
                    exceed project goals. My background in creating and
                    implementing unit and integration tests ensures software
                    reliability, and a strong proficiency in TypeScript enhances
